        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-body text-center">
                    <div class="mb-3">
                        <div class="avatar-circle mx-auto" style="width: 100px; height: 100px; background: #3498db; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="text-start">
                        ...
                        <p><i class="fas fa-map-marker-alt me-2"></i> {{ $user->address ?? 'Not provided' }}</p>
                        <p><i class="fas fa-briefcase me-2"></i> {{ ucfirst($employee->employment_type) }}</p>
                        <p><i class="fas fa-calendar-alt me-2"></i> Joined: {{ $employee->joining_date->format('d M Y') }}</p>
                    </div>
                </div>
            </div>
        </div>
