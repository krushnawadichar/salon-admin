  ...
  <section class="py-20 px-6 md:px-12 bg-[#0e0e0e]">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="flex gap-5 overflow-x-auto no-scrollbar snap-x">
        <div class="min-w-[280px] md:min-w-[420px] h-72 rounded-2xl overflow-hidden snap-center relative group flex-shrink-0"><img src="https://images.unsplash.com/photo-1585747860715-2ba37e788b70?w=800&q=80" alt="Salon suite" class="w-full h-full object-cover group-hover:scale-110 transition duration-700" /><div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition flex items-center justify-center"><span class="text-white font-bold tracking-widest">PRIVATE SUITES</span></div></div>
        <div class="min-w-[280px] md:min-w-[420px] h-72 rounded-2xl overflow-hidden snap-center relative group flex-shrink-0"><img src="https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=800&q=80" alt="Academy" class="w-full h-full object-cover group-hover:scale-110 transition duration-700" /><div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition flex items-center justify-center"><span class="text-white font-bold tracking-widest">TECHNICAL ACADEMY</span></div></div>
        <div class="min-w-[280px] md:min-w-[420px] h-72 rounded-2xl overflow-hidden snap-center relative group flex-shrink-0"><img src="https://images.unsplash.com/photo-1560066984-138dadb4c035?w=800&q=80" alt="Styling bay" class="w-full h-full object-cover group-hover:scale-110 transition duration-700" /><div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition flex items-center justify-center"><span class="text-white font-bold tracking-widest">LUXURY STYLING BAY</span></div></div>
      </div>
    </div>
  </section>
...
<div id="bookingModal" class="modal-overlay">
  <div class="modal-box">
    ...
    <form id="bookingForm" class="space-y-5">
      ...
      <div>
        <label class="text-xs uppercase tracking-wider text-[#a98892] block mb-1.5">Email (optional)</label>
